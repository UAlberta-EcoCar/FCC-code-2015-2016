...
//Analog Inputs
#define MODEBTN1 AVR32_ADCIN14_PIN  
#define MODEBTN2 AVR32_ADCIN13_PIN  
#define MODEBTN3 AVR32_ADCIN12_PIN  
#define MODEBTN4 AVR32_ADCIN11_PIN  
...
static const gpio_map_t ADCIFA_GPIO_MAP = {
    {MODEBTN1,AVR32_ADCIN14_FUNCTION},  
    {MODEBTN2,AVR32_ADCIN13_FUNCTION},  
    {MODEBTN3,AVR32_ADCIN12_FUNCTION},  
    {MODEBTN4,AVR32_ADCIN11_FUNCTION},  
...
adcifa_opt_t adcifa_opt = {
    .frequency                = 250000,  // ADC frequency (Hz) //worked at 10000 and 250000, 500000
